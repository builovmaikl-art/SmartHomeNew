...
target = Path("docs/runtime/PLC_first_run_report_template.md")

content = """# PLC First Run Report Template
...
print("OK: created docs/runtime/PLC_first_run_report_template.md")
