...
p = Path("FB_State_Manager.st")
if not p.exists():
    raise SystemExit("FB_State_Manager.st not found")
...
Path("диагностика/state_manager_audit.txt").write_text("\n".join(report), encoding="utf-8")
print("OK: state manager audit complete")
