...
actuator_words = []
for w in ["Valve", "Pump", "Heater", "Lighting", "Blind", "Socket", "Alarm", "Open", "Close", "Fan", "Vent"]:
    if w in text:
...
Path("диагностика/ventilation_manager_audit.txt").write_text("\n".join(report), encoding="utf-8")
print("OK: ventilation manager audit complete")
